    ...
    <div className="h-[100vh] w-full">
      <div className="h-[48px] p-2 bg-[#0d0d0d]">
        <div className="flex items-center justify-start">
          <label
            htmlFor="select"
            className="text-lg py-2 mx-4 text-[#B5A996] font-medium"
          >
            Language
          </label>
      ...
      <div className="h-[67%] flex justify-center bg-[#0d0d0d] mx-5 my-3">
        <Editor
          width="100%"
          theme="vs-dark"
      ...
      <div className="flex justify-end bg-[#0d0d0d] mr-3" id="font_proxima">
        <button
          className="w-[180px] py-2 mr-4 rounded bg-[#242424] text-white hover:bg-[#1a1919] active:bg-[#242424]"
          onClick={handleClick}
        >
          Run Code
        </button>
        <button
          className="w-[180px] py-2 mr-2 rounded text-white bg-[#EB5939] hover:bg-red-600 active:bg-[#EB5939]"
          onClick={handleClick}
        >
          Submit Code
        </button>
