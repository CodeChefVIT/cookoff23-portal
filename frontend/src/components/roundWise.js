...
function RoundWise() {
  ...
  return (
    <div className="w-[60%] ml-10 h-[83vh] overflow-auto">
              ...
              <div className="bg-[#161616] leading-relaxed flex justify-between">
                ...
                <div className="mt-2">
                  {question.qdata.map((question2, index2) => (
                    <div
                      className="bg-[#363434] flex w-[500px] justify-between h-[35px] items-center mb-1 rounded-lg mr-2 text-md font-light"
                      id="font_ITC"
                      key={index2}
                    >
